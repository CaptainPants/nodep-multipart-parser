...
): errorConstructor is ErrorConstructorOnChrome {
    return (
        typeof (errorConstructor as ErrorConstructorOnChrome)
...
Object.setPrototypeOf(ErrorBase.prototype, Error.prototype);
